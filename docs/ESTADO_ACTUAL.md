...
##  DIAGN�STICO CR�TICO: Odontograma & Wizard (2026-01-06)
**Problema**: Desconexi�n total entre la interfaz visual (Odontograma) y la l�gica transaccional (Wizard).
**Diagn�stico**: 
...
**Soluci�n Documentada**: Ver \docs/DEBUG_ODONTOGRAMA_WIZARD.md\.

###  PLAN DE TRABAJO (FIX INTEGRACI�N)
1. **Modificar Odontograma**: A�adir prop \onTreatmentSelect\ y emitir evento al seleccionar pr�tesis.
