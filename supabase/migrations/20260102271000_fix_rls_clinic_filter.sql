-- CRITICAL SECURITY FIX: Add clinic_id filtering to RPCs
-- Description: Ensure clinics only see their own data

-- Drop existing function
DROP FUNCTION IF EXISTS public.get_lab_kanban();

-- Recreate with clinic_id filtering
...
COMMENT ON FUNCTION public.get_lab_kanban IS 'Get kanban orders filtered by clinic_id for clinic users';
