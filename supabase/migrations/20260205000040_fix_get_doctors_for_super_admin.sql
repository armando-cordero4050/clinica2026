-- =====================================================
-- Migration: Fix Get Doctors RPC for Super Admin
-- Date: 2026-02-05
-- Description: Updates get_doctors_rpc to work with super_admin users
-- =====================================================
...
COMMENT ON FUNCTION public.get_doctors_rpc IS 'Gets all doctors (name/email) in the current user''s clinic, or all doctors if super_admin';
