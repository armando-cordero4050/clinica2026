...
```
cuenta cuantos tokens nos quedan restantes con cada modelo de IA que usemos, basado en ese conteo ants que nos quedemos sin tokens por sesion. actualiza toda la informacion para no perder contexto
---
